...
function general1(){
    ...
    if (puntos == puntosPasarNivel){
        ...
        puntos = 0;
        document.getElementById("puntos").innerHTML =  "PUNTOS " + "&nbsp;&nbsp;&nbsp;" + puntos + "/" + puntosPasarNivel;
        document.getElementById("pasar_de_nivel").innerHTML = /* confirm("Nivel 2!!"),  */window.location.replace("../niveles_topoSmash/nivel5.html");
    }
...
function general2(){
    ...
    if (puntos == puntosPasarNivel){
        ...
        puntos = 0;
        document.getElementById("puntos").innerHTML = "PUNTOS " + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + puntos + "/" + puntosPasarNivel;
        document.getElementById("pasar_de_nivel").innerHTML = window.location.replace("../niveles_topoSmash/nivel5.html");
    }
}
////////////////////////////////////////////////////////////////////////////////
/////////                 TOPO3                   ////
...
function general12(){
    ...
    if (puntos == puntosPasarNivel){
       /*  alert("Ganastes, eres lo maximo, como tu no hay otro!!!") */
        ...
        puntos = 0;
        document.getElementById("puntos").innerHTML = "PUNTOS " + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + puntos + "/" + puntosPasarNivel;
        document.getElementById("pasar_de_nivel").innerHTML = /* confirm("Nivel 4!!"),  */window.location.replace("../niveles_topoSmash/nivel5.html");
